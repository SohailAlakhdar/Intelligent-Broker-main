...
function ApproveEstateReq(props) {
  ...
  const handleStatusFilterChange = (event) => {
    if (props.estateRequests !== "NoData") {
      let update = props.estateRequests.filter(
        (i) => typeof i.auctionData === event.target.value,
      );
      setData(update);
    }
  ...
  return (
    <ServicesProductContainer id="EstatesRequests">
      ...
      <FilterBox
        ...
        options={[
          { value: "object", title: "Auction Requests" },
          { value: "undefined", title: "Estates Requests" },
        ]}
      />
                      ...
                      <TableCell colSpan="5">
                        <TableExpandDiv>
                            ...
                            <TableBody>
                              <TableRow>
                                <TableCell colSpan="4" align="center">
                                  Auction Duration : {e.auctionData.duration}{" "}
                                  Weeks
                                </TableCell>
                              </TableRow>
                            </TableBody>
                          ...
                          <TableBody>
                            <TableRow>
                              <TableCell colSpan="2" align="center">
                                <PicSlider from={"details"} pic={e.pic} />
                              </TableCell>
                              <TableCell colSpan="2" align="center">
                                <PicSlider
                                  from={"details"}
                            ...
                            <TableRow>
                              ...
                              <TableCell colSpan="2" align="center">
                                <Button
                                  color="error"
                                  onClick={() => {
                                    handelDecisionBtn(e._id, "rejected");
                                  }}
                                  variant="outlined"
                                  startIcon={<CloseIcon />}
                                >
