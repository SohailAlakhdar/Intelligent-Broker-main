...
import * as serverFunctions from "../serverFunctions/user";
    ...
    <MyContext.Consumer>
      {(context) => {
                  ...
                  <Badge
                    badgeContent={
                      context.visitRequests.pending
                        ? context.visitRequests.pending.length
                        : 0
                    }
                  ...
                  <OptionsBarLinks to="/adminDashBoard#EstatesRequests">
                    <Badge
                      badgeContent={
                        ...
                        context.estateRequests === "NoData"
                          ? 0
                          : context.estateRequests.length
                      }
                      anchorOrigin={{ vertical: "top", horizontal: "left" }}
                      color="error"
                    >
        ...
        return (
          <>
            {props.Mobile ? (
              <SidebarRoute to="#" onClick={toggleDrawer(true)}>
                View Bar
              </SidebarRoute>
            ) : (
