...
function ApproveEstateReq(props) {
  ...
  const handelChange = (data, status) => {
    ...
    if (statusFilter === "myVisit") {
      ...
      update = props.visitRequests[statusFilter].filter(
        (i) => i._id !== data._id,
      );
  ...
  return (
    <ServicesProductContainer id="VisitRequests">
      ...
      {validation ? (
        ...
        <TableContainer component={Paper}>
          ...
          >
            ...
            <TableBody>
              {(rowsPerPage > 0
                ? props.visitRequests[statusFilter].slice(
                    page * rowsPerPage,
                    page * rowsPerPage + rowsPerPage,
                  )
                : props.visitRequests[statusFilter]
              ).map((e) => (
