...
import * as serverEstateFunctions from "../serverFunctions/estate";
    ...
    <MyContext.Consumer>
      {(context) => {
        const approveEstateReqSec = () => {
          if (
            context.saveList === "error" ||
            context.saveList === "NoData" ||
            context.saveList === "Loading"
          ) {
            return context.saveList;
          }

          return context.saveList.map((item) => {
        ...
        return (
          <div>
            ...
            />
            <ApproveVisitReq
              visitRequests={context.visitRequests}
              myVisits={context.myVisits}
              setVisitRequests={context.setVisitRequests}
            />
          </div>
        );
      }}
